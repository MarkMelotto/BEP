...
for wavelength in list_wavelengths:
    low_humidity_absorption_coefficient, high_humidity_absorption_coefficient = \
        0, WIKI_absorption_coefficient_air_composition_high_humidity(absorption_coefficient_water[wavelength])
    ...
    print(f"\n"
          ...
          f"no water vapor: {absorbed_light_low_humidity_intensity:.4} Watt/cm2, {intensity_low_dB:.4} dB\n"
          f"3% water vapor: {absorbed_light_high_humidity_intensity:.4} Watt/cm2, {intensity_high_dB:.4} dB\n"
