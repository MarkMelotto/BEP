...
# some data on the absorption coefficients on molecules:
def get_mu_water():
...
def find_humidity_from_intensity_at_T(start_intensity, received_intensity, path_length, mu_N2, mu_O2, mu_CO2, mu_H2O, T):
    N2 = 0.78
    O2 = 0.209
    CO2 = 0.0003
    high_H2O = calculate_maximum_percentage_water(T)
