...
for wavenumber in list_of_wavenumbers:
    ...
    low_humidity_absorption_coefficient, high_humidity_absorption_coefficient = \
        absorption_coefficient_air_composition_low_high_humidity(mu_nitrogen[wavenumber], mu_oxygen[wavenumber],
    ...
    absorbed_light_low_humidity_intensity = measure_intensity(start_laser_intensity, low_humidity_absorption_coefficient,
                                                    path_length_laser)
    absorbed_light_high_humidity_intensity = measure_intensity(start_laser_intensity, high_humidity_absorption_coefficient,
                                                     path_length_laser)
    ...
    print(f"\n"
          ...
          f"low humidity: {absorbed_light_low_humidity_intensity} Watt/cm2, {intensity_low_dB:.4} dB\n"
          f"high humidity: {absorbed_light_high_humidity_intensity} Watt/cm2, {intensity_high_dB:.4} dB\n"
